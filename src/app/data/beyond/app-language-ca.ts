...
{% set languageSheet = {
  ...
  messageHeaderReserve: 'Moltes gràcies per confiar en nosaltres. Hemos recibido tu pedido, al tener algún producto por encargo lo tenemos pendiente de revisión.',
