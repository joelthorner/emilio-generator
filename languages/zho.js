...
<tr>
  <td style="padding: 20px 20px 20px 20px;color: #000;font-family: Arial, sans-serif;font-size: 18px;line-height: 20px;text-align:center;">
    ...
    <span style="font-size: 15px;">您好</span><br><br><span style="font-size: 15px;">謝謝您訂閱我們的資訊，我們會為您發送我們的公司相關的最新動態，活動，熱門產品和促銷信息。</span><br><br><span style="font-size: 15px;">我們期待能在</span><a href="%%ecommerceURL%%" style="font-size: 15px; color: rgb(0, 0, 0);">%%ecommerceName%%</a><span style="font-size: 15px;">&nbsp;見到您</span>
  </td>
</tr>
`,
    footer : `
...
<tr>
  <td style="padding: 20px 20px 20px 20px;color: #000;font-family: Arial, sans-serif;font-size: 18px;line-height: 20px;text-align:center;">
    ...
    <span style="font-size:15px;">您好 %firstName% %lastName%,<br/><br/>我們很高興地通知您，%%ecommerceURL%% 中的客戶帳戶已成功激活。<br /><br />您可以通過訪問此控制面板隨時查看和修改所有詳細信息 <a href="%%ecommerceURL%%" style="color:#000">編輯您的個人資料</a><br /><br />我們希望很快能見到你 <a href="%%ecommerceURL%%" style="color:#000">%%ecommerceName%%</a>.<br /><br />%%ecommerceName%% 球隊</span>
  </td>
</tr>
`
  }, // end 18
